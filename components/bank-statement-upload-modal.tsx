...
import BankStatementResultViewer from "@/components/bank-statement-result-viewer"
  ...
  const processOcrResponse = (data: any) => {
    ...
    if (Array.isArray(data) && data.length > 0) {
      ...
      return {
        ...
        bankStatement: {
          accountHolder: output["Nom du titulaire"] || "",
          bank: output["Banque"] || "",
          accountNumber: output["Numéro de compte"] || "",
          statementDate: output["Date de relevé"] || "",
          previousBalance: Number.parseFloat(output["Ancien solde"] || "0"),
          newBalance: Number.parseFloat(output["Nouveau solde"] || "0"),
          currency: "MAD",
      ...
      return {
        ...
        bankStatement: {
          ...
          previousBalance: Number.parseFloat(data.previousBalance || data.ancienSolde || "0"),
          newBalance: Number.parseFloat(data.newBalance || data.nouveauSolde || "0"),
      ...
      <DialogContent className="sm:max-w-[650px] p-0 overflow-hidden">
        <DialogHeader className="p-6 pb-2">
          ...
          <DialogDescription className="text-sm text-muted-foreground">
            Téléchargez un relevé bancaire pour extraction automatique des données
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="p-6 space-y-8 py-12">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground mt-2">
                Veuillez patienter pendant que nous analysons votre relevé bancaire...
              </p>
            </div>
        ...
        {currentStep === "results" && ocrResults && (
          <div className="p-6 space-y-6">
            <BankStatementResultViewer data={ocrResults} />
