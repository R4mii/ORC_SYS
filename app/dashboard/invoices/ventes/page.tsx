...
export default function VentesPage() {
  ...
  useEffect(() => {
    ...
    // Get sales documents for this company
  ...
  const handleViewInvoice = (id: string) => {
    router.push(`/dashboard/invoices/${id}?type=sales`)
  }
  ...
  const actions = [
    ...
    {
      label: "Modifier",
      onClick: (invoice: Invoice) => router.push(`/dashboard/invoices/${invoice.id}?edit=true&type=sales`),
    },
    {
      label: "Supprimer",
